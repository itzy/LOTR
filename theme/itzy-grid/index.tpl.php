...
<head>
    <meta charset='utf-8'/>
    <title><?php echo $title . $title_append?></title>
    <?php if(isset($favicon)): ?><link rel='icon' href='<?php echo $this->url->asset($favicon)?>'/><?php endif; ?>
    <?php foreach($stylesheets as $stylesheet): ?>
        <link rel='stylesheet' type='text/css' href='<?php echo $this->url->asset($stylesheet)?>'/>
    <?php endforeach; ?>
    <?php if(isset($style)): ?><style><?php echo $style?></style><?php endif; ?>
    <script src='<?php echo $this->url->asset($modernizr)?>'></script>
</head>
<body>
...
<?php if(isset($jquery)):?><script src='<?php echo $this->url->asset($jquery)?>'></script><?php endif; ?>

<?php if(isset($javascript_include)): foreach($javascript_include as $val): ?>
    <script src='<?php echo $this->url->asset($val)?>'></script>
