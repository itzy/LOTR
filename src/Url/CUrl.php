...
class CUrl
{
    ...
    private $siteUrl = 'http://www.student.bth.se/~jusi14/mvc/projekt/webroot/index.php'; // Siteurl to prepend to all absolute urls created
    private $baseUrl = 'http://www.student.bth.se/~jusi14/mvc/projekt/webroot/'; // Baseurl to prepend to all relative urls created
