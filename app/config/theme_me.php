...
return [
    ...
    'views' => [
        [
            ...
            'template' => 'me/header',
            'data'     => [
                'siteTitle' => "All about LOTR",
                'siteTagline' => "Copyright by Julia Sivartsson",
            ],
            'sort'     => -1
        ],
    ...
    'data' => [
        ...
        'title_append' => ' | All about LOTR',

        // Stylesheets
        'stylesheets' => ['css/style.css', 'css/navbar_me.css', 'css/litennavbar.css'],
